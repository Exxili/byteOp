/**
 * Returns a Uint32 Number from an Array of 4 Uint8's
 * @param {number} bytes - The Number as Uint8Array of 4 Bytes
 * @param {number} decimalPlaces - How many decimal places
 * @returns {number|Error} returns Uint32 Number else returns Failure Error if byte array is incorrect length
 * @example 
 ...
 * 
 */
export function toUint32 (bytes: Uint8Array): number | Error {
...
/**
 * Returns an array of Uint8 Values from a Uint32 number
 * @param {number} int - The Number as a Uint32 e.g 123456789
 ...
 * 
 */
export function fromUint32 (int: number): Uint8Array {
